...
import lasanha from "../img/lasanha.jpg";
import ravioli from "../img/ravioli.jpg";
import capeletti from "../img/capeletti.jpg";
import nhoque from "../img/nhoque.jpg";
import bruschetta from "../img/bruschetta.jpg";
import carpaccio from "../img/carpaccio.jpg";
import paella from "../img/paella.jpg";
import ebiSpicy from "../img/ebi-spicy.jpg";
import aligot from "../img/aligot.jpg";
import fileMignon from "../img/file-mignon.jpg";
import picanha from "../img/picanha.png";
import bifeAncho from "../img/bife-ancho.jpg";
import tomahwankSteak from "../img/tomahawk-steak.jpg";
import primeRib from "../img/prime-rib.jpg";
import tiramisu from "../img/tiramisu.jpg";
import cheesecake from "../img/cheesecake.jpg";
import banoffee from "../img/banoffee.png";
import milFolhas from "../img/mil-folhas.jpg";
import pudim from "../img/pudim.jpg";
import cerveja from "../img/cerveja.jpg";
import refrigerante from "../img/refrigerante.jpg";
import suco from "../img/suco.jpg";
import whiskey from "../img/whiskey.jpg";
import agua from "../img/agua.jpg";
import saladaCeasar from "../img/salada-ceasar.jpg";
import saladaCaprese from "../img/salada-caprese.jpg";
import saladaWaldorf from "../img/salada-waldorf.jpg";
import saladaGrega from "../img/salada-grega.jpg";
import saladaNicoise from "../img/salada-nicoise.jpg";
